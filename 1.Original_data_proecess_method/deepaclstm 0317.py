...
def plotLoss(history):
    ...
    plt.savefig("figures/"+'lstmloss06_0317' +".png" , dpi=600, facecolor='w', edgecolor='w', orientation='portrait', 
    ...
    plt.savefig("figures/"+'lstmaccuracy06_0317'+ ".png" , dpi=600, facecolor='w', edgecolor='w', orientation='portrait', 
                            papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,frameon=None)
