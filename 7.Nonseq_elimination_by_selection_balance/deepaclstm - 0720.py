...
def plotLoss(history):
    ...
    plt.savefig("figures/"+'lstmloss06_0720' +".png" , dpi=600, facecolor='w', edgecolor='w', orientation='portrait', 
    ...
    plt.savefig("figures/"+'lstmaccuracy06_0720'+ ".png" , dpi=600, facecolor='w', edgecolor='w', orientation='portrait', 
                            papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,frameon=None)
...
load_file = "model/ac_LSTM_best_time_26_07_20.h5" # M: val_loss E: val_weighted_accuracy
