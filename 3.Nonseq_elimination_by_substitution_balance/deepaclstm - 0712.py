...
def plotLoss(history):
    ...
    plt.savefig("figures/"+'lstmloss06_0712' +".png" , dpi=600, facecolor='w', edgecolor='w', orientation='portrait', 
    ...
    plt.savefig("figures/"+'lstmaccuracy06_0712'+ ".png" , dpi=600, facecolor='w', edgecolor='w', orientation='portrait', 
                            papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,frameon=None)
...
load_file = "model/ac_LSTM_best_time_26_07_12.h5" # M: val_loss E: val_weighted_accuracy
...
history=model.fit({'main_input': traindatahot, 'aux_input': trainpssm}, {'main_output': trainlabel},validation_data=({'main_input': valdatahot, 'aux_input': valpssm},{'main_output': vallabel}),
        nb_epoch=200, batch_size=44, callbacks=[checkpointer, earlyStopping], verbose=1, shuffle=True)
plotLoss(history)
